...
def grade_all_tests(minic_path, testcase_dir='base/testcases', solution_dir='base/solutions'):
    total = 0
    passed = 0
    results = []
...
if __name__ == "__main__":
    ...
    parser.add_argument("--testcase_dir", type=str, default="base/testcases", help="Path to test case inputs")
    parser.add_argument("--solution_dir", type=str, default="base/solutions", help="Path to expected outputs")
